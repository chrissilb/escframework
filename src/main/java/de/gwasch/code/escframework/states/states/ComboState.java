...
public class ComboState<T> extends CompositeState<T> {
    ...
    public ComboState(Class<T> stateType, String name, SimpleAggregation<T> aggregaton) {
    ...
    public T getLocalValue() {
            ...
            if (localState != null) return localState.getValue(); 
            else throw new LocalStateNotFoundException(); 
        }
